...
export class SafeAccountV0_2_0 extends SmartAccount {
	...
	public async estimateUserOperationGas(
		...
		const verificationGasLimit =
			BigInt(estimation.verificationGasLimit) + 5000n;
	...
	public async createUserOperation(
		...
		maxPriorityFeePerGas =
			overrids.maxPriorityFeePerGas ?? maxPriorityFeePerGas;
		...
		userOperation.preVerificationGas =
			overrids.preVerificationGas ?? preVerificationGas;
		userOperation.verificationGasLimit =
			overrids.verificationGasLimit ?? verificationGasLimit;
		userOperation.callGasLimit = overrids.callGasLimit ?? callGasLimit;
